...
const handleSubmit = async () => {
  ...
  await signUp.email(
    ...
    },
    {
      ...
      onSuccess() {
        isLoading.value = false
        success.value = "Kayıt başarılı! Yönlendiriliyorsunuz..."
        setTimeout(() => {
          navigateTo('/sign-in')
        }, 2000)
      },
  ...
  <form :class="cn('flex flex-col gap-6', props.class)" @submit.prevent="handleSubmit">
    <FieldGroup>
      ...
      <Field>
        ...
        />
        <FieldDescription>
          Bu e-posta ile sizinle iletişime geçeceğiz.
        </FieldDescription>
      </Field>
      <Field>
      ...
      <Field>
        ...
        <Input 
          ...
          required 
        />
        <FieldDescription>Lütfen şifrenizi doğrulayın.</FieldDescription>
      </Field>
      <Field>
        <Button type="submit" :disabled="isLoading || !name || !email || !password || !confirmPassword">
      ...
      <Field>
        <Button variant="outline" type="button" :disabled="isGoogleLoading" @click="handleGoogleSignUp">
        ...
        <FieldDescription class="px-6 text-center">
          Zaten bir hesabınız var mı? <NuxtLink to="/sign-in" class="underline text-primary">Giriş Yap</NuxtLink>
        </FieldDescription>
      </Field>
    </FieldGroup>
  </form>
